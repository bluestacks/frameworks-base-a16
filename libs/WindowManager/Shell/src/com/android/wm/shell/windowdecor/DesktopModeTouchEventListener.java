...
public class DesktopModeTouchEventListener
    ...
    @Nullable
    private ActivityManager.RunningTaskInfo getOtherSplitTask(int taskId) {
        @SplitScreenConstants.SplitPosition int remainingTaskPosition = mSplitScreenController
