 ...
 */
class WindowDecorationWrapper private constructor(
    ...
    val manageWindowsMenuController: ManageWindowsMenuController?
        get() = when {
            defaultWindowDecor != null -> requireDefaultWindowDecor().manageWindowsMenuController
            desktopWindowDecor != null -> requireDesktopWindowDecor()
            else -> error("Expected Non-null default or desktop window decoration")
        }
    ...
    /**
     * Returns the valid drag area for this task associated with the window decor if the task can
     * be dragged. Otherwise, returns null.
     */
    fun calculateValidDragArea() = when {
    ...
    fun relayout(
        ...
        defaultWindowDecor != null -> {
            requireDefaultWindowDecor().relayout(
                taskInfo,
                isFocused,
                exclusionRegion
            )
        ...
        desktopWindowDecor != null -> {
            requireDesktopWindowDecor().relayout(
                taskInfo,
                isFocused,
                exclusionRegion
            )
        ...
        captionWindowDecoration != null -> {
            requireCaptionWindowDecor().relayout(
                taskInfo,
                isFocused,
                exclusionRegion
            )
     ...
     */
    fun setIsRecentsTransitionRunning(
        isRecentsRunning: Boolean
    ) = when {
        defaultWindowDecor != null -> {
     ...
     */
    fun disposeStatusBarInputLayer() = when {
    ...
    fun checkTouchEventInCustomizableRegion(
        e: MotionEvent
    ) = when {
        defaultWindowDecor != null -> {
    ...
    fun shouldResizeListenerHandleEvent(
        e: MotionEvent,
        offset: Point
    ) = when {
        defaultWindowDecor != null -> {
    ...
    fun handleDragInterrupted() = when {
    ...
    fun setAnimatingTaskResizeOrReposition(
        animatingTaskResizeOrReposition: Boolean
    ) = when {
        defaultWindowDecor != null -> {
            requireDefaultWindowDecor().setAnimatingTaskResizeOrReposition(
                animatingTaskResizeOrReposition
            )
        }

        desktopWindowDecor != null -> {
            requireDesktopWindowDecor().setAnimatingTaskResizeOrReposition(
                animatingTaskResizeOrReposition
            )
        }
    ...
    fun showResizeVeil(
        ...
        defaultWindowDecor != null -> {
            requireDefaultWindowDecor().showResizeVeil(
                t,
                bounds
            )
        }
        ...
        desktopWindowDecor != null -> {
            requireDesktopWindowDecor().showResizeVeil(
                t,
                bounds
            )
        }
    ...
    fun onKeyguardStateChanged(
        visible: Boolean,
        occluded: Boolean
    ) = when {
        defaultWindowDecor != null -> {
            requireDefaultWindowDecor().onKeyguardStateChanged(
                visible,
                occluded
            )
        }
        ...
        desktopWindowDecor != null -> {
            requireDesktopWindowDecor().onKeyguardStateChanged(
                visible,
                occluded
            )
        }
     ...
     */
    fun checkTouchEventInFocusedCaptionHandle(
        e: MotionEvent
    ) = when {
        defaultWindowDecor != null -> {
            false
    ...
    fun updateDisabledResizingEdge(
        ...
        defaultWindowDecor != null -> {
            requireDefaultWindowDecor().updateDisabledResizingEdge(
        ...
        desktopWindowDecor != null -> {
            requireDesktopWindowDecor().updateDisabledResizingEdge(
                disabledResizingEdge,
                shouldDelayUpdate
            )
        }
    ...
    fun setCaptionListeners(
        ...
        defaultWindowDecor != null -> {
            requireDefaultWindowDecor().setListeners(
                onClickListener,
                onTouchListener,
        ...
        desktopWindowDecor != null -> {
            requireDesktopWindowDecor().setCaptionListeners(
                onClickListener,
                onTouchListener,
                checkNotNull(onLongClickListener)
                { "Expected non-null long click listener" },
        ...
        captionWindowDecoration != null -> {
            requireCaptionWindowDecor().setCaptionListeners(
                onClickListener,
                onTouchListener,
            )
        }
     ...
     * dismissed.
     */
    fun setExclusionRegionListener(
        exclusionRegionListener: ExclusionRegionListener
    ) = when {
        defaultWindowDecor != null -> {
    ...
    fun setDragPositioningCallback(
        taskPositioner: TaskPositioner
    ) = when {
        defaultWindowDecor != null -> {
     ...
     */
    fun a11yAnnounceNewFocusedWindow() = when {
    ...
    class Factory {
        ...
        /** Returns a [WindowDecorationWrapper]. */
        fun fromDefaultDecoration(
            defaultWindowDecor: DefaultWindowDecoration
        ) = WindowDecorationWrapper(
            desktopWindowDecor = null,
