...
class SnapResizeAppWindowRightWithDragFlickerTest(flicker: FlickerTest) : DesktopModeBaseTest(
    flicker
) {

    inner class SnapResizeAppWindowRightWithDragScenario : SnapResizeAppWindowWithDrag(
        toLeft = false,
