...
class DragZoneFactory(
    ...
    fun onConfigurationUpdated() {
        ...
        expandedViewDropTargetWidth =
            context.resolveDimension(R.dimen.drop_target_expanded_view_width)
        expandedViewDropTargetHeight =
            context.resolveDimension(R.dimen.drop_target_expanded_view_height)
        expandedViewDropTargetPaddingBottom =
            context.resolveDimension(R.dimen.drop_target_expanded_view_padding_bottom)
        expandedViewDropTargetPaddingHorizontal =
            context.resolveDimension(R.dimen.drop_target_expanded_view_padding_horizontal)
    }
